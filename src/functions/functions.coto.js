...
var getProducsCoto = function (page, url, search) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, functions_1.getPagination)(page, config_coto_1.PAGINATION_SELECTOR)];
            case 2:
                pages = _a.sent();
                if (pages.length === 0)
                    pages.push({ page: 1 });
                ...
                _a.label = 3;
            case 3:
                if (!(index <= pages.length)) return [3 /*break*/, 8];
            ...
            case 5:
                ...
                if (!(pages.length > 1 && pages.length != index)) return [3 /*break*/, 7];
